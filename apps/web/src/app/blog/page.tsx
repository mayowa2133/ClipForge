...
export const metadata: Metadata = {
	...
	description:
		"Read the latest news and updates about ClipForge, the free and open-source video editor.",
	openGraph: {
		title: "Blog - ClipForge",
		description:
			"Read the latest news and updates about ClipForge, the free and open-source video editor.",
...
export default async function BlogPage() {
	...
	return (
		<BasePage
			title="Blog"
			description="Read the latest news and updates about ClipForge, the free and open-source video editor."
		>
