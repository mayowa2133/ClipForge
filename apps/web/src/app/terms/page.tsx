...
export const metadata: Metadata = {
	...
	description:
		"ClipForge's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	openGraph: {
		title: "Terms of Service - ClipForge",
		description:
			"ClipForge's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	...
	return (
		...
		>
				...
				>
					...
					<AccordionContent>
						...
						<ol className="list-decimal space-y-2 pl-6">
							...
							<li>Don't use ClipForge for illegal activities or harassment</li>
							<li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					<strong>You own everything you create.</strong> ClipForge processes
					...
					projects, or any content you create using ClipForge.
				</p>
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>No watermarks, no licensing restrictions from ClipForge</li>
				</ul>
			</section>

			<section className="flex flex-col gap-3">
				<h2 className="text-2xl font-semibold">How You Can Use ClipForge</h2>
				<p>ClipForge is free for personal and commercial use. You can:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
						Create videos for personal, educational, or commercial purposes
					</li>
					<li>Use ClipForge for client work and paid projects</li>
					<li>Share and distribute videos created with ClipForge</li>
					<li>
						Modify and distribute the ClipForge software (under MIT license)
					</li>
				</ul>
				<p>
					<strong>What we ask:</strong> Don't use ClipForge for illegal
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					ClipForge offers optional AI-powered features that require server
					processing:
				</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					ClipForge is provided "as is" without warranties. While we strive for
			...
			<section className="flex flex-col gap-3">
				...
				<p>Because ClipForge is open source, you have additional rights:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Review our code to see exactly how we handle your data</li>
					<li>Self-host ClipForge on your own servers</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					When using ClipForge, make sure you have the right to use any content
					you import:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					ClipForge is provided free of charge. To the extent permitted by law:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>We may update ClipForge and these terms:</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>You can stop using ClipForge at any time:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Delete your account through your profile settings</li>
					<li>Clear your browser data to remove local projects</li>
					<li>Your content remains yours even if you stop using ClipForge</li>
